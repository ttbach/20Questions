...
public class TwentyQuestionsView extends JPanel
{
	...
	private JButton yes; 
	private JButton no; 
	private JTextField question; // text field in center panel
		...
		no.addActionListener( new ActionListener()
		{
			public void actionPerformed(ActionEvent e)
			{
				...
				else
				{
					...
					CommutativeExpressionWriter.writeCommutativeExpr(controller.tree, "food.xml");
	 ...
	 * Calls enterAnswer, enterQuestion, and enterYN
	 */
	public void optionPane()
	{
		...
		JTextField instruct = new JTextField("Please fill out both fields below. Then, click yes or no"
				+ ", corresponding to your answer to your question");
		instruct.setEditable(false);
		JTextField answer = new JTextField("Fill in the answer to the food that you crave");
		JTextField question2 = new JTextField("Fill in the question to your answer");
		...
		int choice = JOptionPane.showOptionDialog(this, textFields, "Texts", JOptionPane.YES_NO_OPTION, 
		...
		BinaryTreeNode<String> origAnswer = new BinaryTreeNode<String>(origData);
		
		// if Yes, add left child
		if (choice == 1)
		{
			previous.setData(strQuestion);
			BinaryTreeNode<String> newChild = new BinaryTreeNode<String>(strAnswer);
			previous.setLeft(newChild);
			previous.setRight(origAnswer);
		...
		else
		{
			previous.setData(strQuestion);
			BinaryTreeNode<String> newChild = new BinaryTreeNode<String>(strAnswer);
			previous.setRight(newChild);
			previous.setLeft(origAnswer);
			question.setText("Please press restart");
		}
